...
class PolyswarmAPI(object):
    ...
    def search(self, hash_, hash_type=None):
        ...
        return resources.ArtifactInstance.search_hash(self, hash_.hash, hash_.hash_type).consume_results()
    ...
    def search_url(self, url):
        ...
        return resources.ArtifactInstance.search_url(self, url).consume_results()
    ...
    def search_scans(self, hash_):
        ...
        return resources.ArtifactInstance.list_scans(self, hash_.hash).consume_results()
    ...
    def search_by_metadata(self, query):
        ...
        return resources.Metadata.get(self, query=query).consume_results()
    ...
    def live_list(self, since=None, all_=None):
        ...
        return resources.LiveHunt.list(self, since=since, all=all_).consume_results()
    ...
    def live_results(self, hunt=None, since=None, tag=None, rule_name=None):
        ...
        return resources.LiveHuntResult.get(self, id=hunt, since=since,
                                            tag=tag, rule_name=rule_name).consume_results()
    ...
    def historical_list(self, since=None):
        ...
        return resources.HistoricalHunt.list(self, since=since).consume_results()
    ...
    def historical_results(self, hunt=None, tag=None, rule_name=None):
        ...
        return resources.HistoricalHuntResult.get(self, id=hunt, tag=tag, rule_name=rule_name).consume_results()
    ...
    def ruleset_list(self):
        ...
        return resources.YaraRuleset.list(self).consume_results()
    ...
    def tag_link_list(self, tags=None, families=None, or_tags=None, or_families=None):
        ...
        return resources.TagLink.list_tag_link(self, tags=tags, families=families,
                                               or_tags=or_tags, or_families=or_families).consume_results()
    ...
    def tag_list(self):
        ...
        return resources.Tag.list(self).consume_results()
    ...
    def family_list(self):
        ...
        return resources.MalwareFamily.list(self).consume_results()
    ...
    def stream(self, since=settings.MAX_SINCE_TIME_STREAM):
        ...
        return resources.ArtifactArchive.get(self, since=since).consume_results()

    def rerun_metadata(self, hashes, analyses=None, skip_es=None):
        logger.info('Rerunning metadata for hashes %s', hashes)
        return resources.ArtifactInstance.metadata_rerun(self, hashes, analyses=analyses, skip_es=skip_es).consume_results()
